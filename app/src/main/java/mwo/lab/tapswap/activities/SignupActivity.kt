...
class SignupActivity : AppCompatActivity() {
    ...
    internal var _addressText: EditText? = null
    internal var _emailText: EditText? = null
    internal var _mobileText: EditText? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _nameText = findViewById<View>(R.id.input_name) as EditText
        _addressText = findViewById<View>(R.id.input_address) as EditText
        _mobileText = findViewById<View>(R.id.input_mobile) as EditText
        _reEnterPasswordText = findViewById<View>(R.id.input_reEnterPassword) as EditText
        _signupButton = findViewById<View>(R.id.btn_signup) as Button
        _loginLink = findViewById<View>(R.id.link_login) as TextView
