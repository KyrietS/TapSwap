...
class MyAccountActivity : AppCompatActivity() {
    ...
    private fun saveChanges() {
        ...
        //sendUptateAccountRequest(name, email, mobile, password)
    }

    private fun sendUptateAccountRequest(
        name: String,
        email: String,
        mobile: String,
        old_password: String,
        ...
        val call = api.addUser(name, email, mobile, old_password)
    ...
    private fun validate(): Boolean { //TODO: validate data changes
        ...
        if (reEnterPassword.isEmpty() || reEnterPassword.length < 4 || reEnterPassword.length > 10 || reEnterPassword != new_password) {
